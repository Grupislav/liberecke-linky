...
$lang['hlavninadpis']   = "Liberec Routes | <a style='color:white' target='_blank' href='https://tomaskrupicka.cz/dopravak/kazda-linka-ma-sve-kouzlo/'>PROJECT IDEA</a>";
$lang['paticka']        = "Contributors: <a style='color:white' target='_blank' href='http://www.boveraclub.com/'>Boveraclub (historical records)</a>, <a style='color:white' target='_blank' href='https://www.youtube.com/channel/UCDnTRePslg2t4wC5MNPKOjQ/'>Liberecká podniková (videos, proofreading)</a>, Tomáš Krupička Sr. (local facts) and others.";
